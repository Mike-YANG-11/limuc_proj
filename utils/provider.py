...
def plot_confusion_matrix_and_save(cm, target_names, path, title="Confusion matrix", cmap=None, normalize=True):
    """
...
def save_confusion_matrix(cm, target_names, path, title="Confusion matrix", cmap=None, normalize=True):
    """
    given a sklearn confusion matrix (cm), make a nice plot
...
def plot_confusion_matrix_TR(cm, target_names, title="Confusion matrix", cmap=None, normalize=True):
    """
    given a sklearn confusion matrix (cm), make a nice plot
...
def plot_confusion_matrix_2(cm, target_names, title="Confusion matrix", cmap=None, normalize=True):
    """
    given a sklearn confusion matrix (cm), make a nice plot
    ...
    for i, j in itertools.product(range(cm.shape[0]), range(cm.shape[1])):
        if normalize:
            ...
            plt.text(j, i, "{:4.3f}".format(cm[i, j]), horizontalalignment="center", color="white" if cm[i, j] > thresh else "black")
...
def plot_confusion_matrix_2_and_save(cm, target_names, path, title="Confusion matrix", save_dpi=600, cmap=None, normalize=True):
    """
    given a sklearn confusion matrix (cm), make a nice plot
...
def get_test_results_classification(model, data_loader, device, calculate_remission=True, nonremission_scores=[2, 3]):
    model.eval()
...
def get_test_results_classification_for_corn_loss_model(model, data_loader, device, calculate_remission=True, nonremission_scores=[2, 3]):
    model.eval()
...
def write_metric_results_to_file(
    wandb_rund_dir,
    accuracies=None,
    kappa_scores=None,
    weighted_kappa_scores=None,
    sensitivities=None,
    specificities=None,
    macro_precisions=None,
    macro_recalls=None,
    macro_f1s=None,
    ...
    accuracies_r=None,
    kappa_scores_r=None,
    sensitivities_r=None,
    specificities_r=None,
    precisions_r=None,
    recalls_r=None,
    f1s_r=None,
):
